...
<div class="novedades-container">
    <?php foreach ($plantas as $plantas): ?>
        <div class="fruta-card">
            <?php if ($plantas['imagen']): ?>
                <img src="data:image/png;base64,<?= base64_encode($plantas['imagen']); ?>" alt="<?= htmlspecialchars($plantas['nombre']); ?>">
            <?php else: ?>
                <img src="images/no-image.png" alt="No disponible">
            <?php endif; ?>
            <h3><?= htmlspecialchars($plantas['nombre']); ?></h3>
            <p class="descripcion-corta"><?= htmlspecialchars($plantas['descripcion']); ?></p>
        </div>
    <?php endforeach; ?>
</div>
