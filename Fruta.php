...
<head>
    ...
    <title>Categorías de Frutas</title>
    <style>
        body {
...
<div class="novedades-container">
    <?php foreach ($frutas as $fruta): ?>
        <div class="fruta-card">
            <?php if ($fruta['imagen']): ?>
                <img src="data:image/png;base64,<?= base64_encode($fruta['imagen']); ?>" alt="<?= htmlspecialchars($fruta['nombre']); ?>">
            <?php else: ?>
                <img src="images/no-image.png" alt="No disponible">
            <?php endif; ?>
            <h3><?= htmlspecialchars($fruta['nombre']); ?></h3>
            <p class="descripcion-corta"><?= htmlspecialchars($fruta['descripcion']); ?></p>
        </div>
    <?php endforeach; ?>
</div>
